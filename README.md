...
The site is live at https://www.easeit.cz. The custom domain is pinned by the `CNAME` file,
which the workflow copies into the published artifact on every deploy; `easeit.cz` redirects to
`www.easeit.cz`. The default GitHub URL, https://easeit-cz.github.io/easeit-site/, still works.
